    ...
    public partial class InitialCreate_1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "1", 0, "af73473c-c99b-49d6-989c-2de1968a3e56", "admin1@example.com", true, false, null, "ADMIN1@EXAMPLE.COM", "ADMIN1", "AQAAAAEAACcQAAAAEBUxA0d/A3X8Q3QfYkAAAAAO5BZ0AICgWZk=", null, false, "649dc351-15ce-43dd-8c48-f17022fe773c", false, "admin1" },
                    { "2", 0, "33e415e3-d9d0-4f2f-9a8d-b55459941afe", "admin2@example.com", true, false, null, "ADMIN2@EXAMPLE.COM", "ADMIN2", "AQAAAAEAACcQAAAAEBUxA0d/A3X8Q3QfYkAAAAAO5BZ0AICgWZk=", null, false, "077bb310-147a-4401-b99a-72e0100fdbbd", false, "admin2" }
                });

            migrationBuilder.InsertData(
                table: "Movies",
                columns: new[] { "Id", "Actors", "CountryOrigin", "Description", "Director", "Distributor", "Duration", "Genre", "ReleaseYear", "Title" },
                values: new object[,]
                {
                    { 1, "Bruce Willis, Uma Thurman", "USA", "Exciting crime drama", "Quentin Tarantino", "Miramax", 150, "Crime Story", 1994, "Pulp Fiction" },
                    { 2, "Keir Dullea, Gary Lockwood", "USA", "Experiment in film form and content", "Stanley Kubrick", "Warner Bros", 149, "Sci-fi/Adventure", 1968, "2001: A Space Odyssey" }
                });

            migrationBuilder.InsertData(
                table: "ProjectionTypes",
                columns: new[] { "Id", "Name", "TheaterId" },
                values: new object[,]
                {
                    { 1, "2D", null },
                    { 2, "3D", null },
            ...
            migrationBuilder.InsertData(
                table: "Projections",
                columns: new[] { "Id", "AdministratorId", "DateTime", "MovieId", "Price", "ProjectionTypeId", "TheaterId" },
                values: new object[,]
                {
                    { 1, "1", new DateTime(2024, 5, 21, 11, 10, 16, 416, DateTimeKind.Local).AddTicks(2555), 1, 500m, 2, 1 },
                    { 2, "2", new DateTime(2024, 5, 21, 11, 10, 16, 416, DateTimeKind.Local).AddTicks(2680), 2, 500m, 3, 2 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 5, 21, 11, 10, 16, 416, DateTimeKind.Local).AddTicks(2799), 1, "1" },
                    { 2, 2, new DateTime(2024, 5, 21, 11, 10, 16, 416, DateTimeKind.Local).AddTicks(2820), 2, "2" }
                });
